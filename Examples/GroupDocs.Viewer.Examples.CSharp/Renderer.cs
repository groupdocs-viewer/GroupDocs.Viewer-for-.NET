...
namespace GroupDocs.Viewer.Examples.CSharp
{
    ...
    {
        /// <summary>
        ///  This class contains the methods that render the input document in HTML representation
        /// </summary>
        public static class HTMLRepresentation 
        {
            /// <summary>
            ...
            public static void RenderDocument(String DocumentName, String DocumentPassword = null)
            {
            ...
            public static void RenderDocument(String DocumentName, String WatermarkText, Color WatermarkColor, WatermarkPosition position = WatermarkPosition.Diagonal, int WatermarkWidth = 100, String DocumentPassword = null)
            {
            ...
            /// <param name="DocumentPassword">Password Parameter is optional</param>
            public static void RenderDocument(Uri DocumentURL, String DocumentPassword = null)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">File name</param>
            public static void RenderWordDocumentWithTrackChanges(String DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">file/document name</param>
            public static void RenderExcelWithInternalHyperlinkPrefix(string DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">file/document name</param>
            public static void RenderExcelWithCountRowsPerPage(string DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">file/document name</param>
            public static void RenderExcelWithTextOverflowMode(string DocumentName)
            {
            ...
            /// <summary>
            /// Renders simple document into html with EnablePreciseRendering settings
            /// </summary>
            /// <param name="DocumentName">File name</param>
            /// <param name="DocumentPassword">Optional</param>
            public static void RenderPDFDocumentWithEnablePreciseRendering(String DocumentName, String DocumentPassword = null)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">File name</param> 
            public static void RenderDocumentWithDefaultFontSetting(String DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">File name</param> 
            public static void RenderDocumentWithComments(String DocumentName)
            {
            ...
            public static void RenderExcelWithGridLinesOptions(String DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName"></param>
            public static void RenderMultipleExcelSheetsInOnePage(String DocumentName)
            {
                // Setup GroupDocs.Viewer config
                ViewerConfig config = Utilities.GetConfigurations();
            ...
            /// <summary>
            ///  Reorder pages of the document pages in HTML based rendering
            /// </summary>
            /// <param name="DocumentName">file/document name</param>
            /// <param name="CurrentPageNumber">Page existing order number</param>
            /// <param name="NewPageNumber">Page new order number</param>
            public static void ReorderDocumentPages(String DocumentName, int CurrentPageNumber, int NewPageNumber)
            {
            ...
            public static void RotateDocumentPages(String DocumentName, int RotationAngle)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">File name</param> 
            public static void RenderProjectDocumentWithProjectOptions(string DocumentName)
            {
            ...
            public static void RenderOutlookDataFileUsingFilters(String DocumentName)
            {
                try
                {
                    //ExStart:RenderOutlookDataFilesUsingFilters_19.1
                    // Setup GroupDocs.Viewer config
                    ViewerConfig config = Utilities.GetConfigurations();
                    ...
                    // Create HTML options with specified text (use ImageOptions to render into image)
                    HtmlOptions options = new HtmlOptions();
                    options.OutlookOptions.TextFilter = "Susan";
                    // For address filter, use OutlookOptions.AddressFilter = "susan";

                    // Get HTML representation
                    List<PageHtml> pages = handler.GetPages(DocumentName);
                    ...
                    //ExEnd:RenderOutlookDataFilesUsingFilters_19.1
                }
            ...
            /// </summary>
            /// <param name="DocumentName">Input document name</param>
            public static void RenderEmailAttachmentFromStream(String DocumentName)
            {
                try
                {
        ...
        /// <summary>
        ///  This class contains the methods that render the input document in image representation
        /// </summary>
        public static class ImageRepresentation
        {
            ...
            public static void RenderEmailAttachmentsFromOutlookDataFile(String DocumentName)
            {
                try
                {
                    //ExStart:RenderEmailAttachmentFromOutlookDataFileAsImage_19.1
                    // Setup GroupDocs.Viewer config
                    ViewerConfig config = Utilities.GetConfigurations();
                    ...
                    foreach (AttachmentBase attachment in info.Attachments)
                    {
                        // Get attachment's image representation
                        List<PageImage> pages = handler.GetPages(attachment);
                    ...
                    //ExEnd:RenderEmailAttachmentFromOutlookDataFileAsImage_19.1
                }
                catch (System.Exception exp)
                {
                    Console.WriteLine(exp.Message);
        ...
        /// <summary>
        ///  This class contains the methods that render the input document in PDF representation
        /// </summary>
        public static class PDFRepresentation
        {
            ...
            /// </summary>
            /// <param name="DocumentName"></param>
            public static void RenderDocument(String DocumentName)
            {
                //ExStart:RenderAsPdf
            ...
            public static void RenderDocument(String DocumentName, String WatermarkText)
            {
                //ExStart:RenderAsPdf
                // Create/initialize image handler 
                ViewerImageHandler imageHandler = new ViewerImageHandler(Utilities.GetConfigurations());
            ...
            public static void RenderDocument(String DocumentName, String WatermarkText, String WatermarkFontName = "MS Gothic")
            {
                //ExStart:RenderAsPdf
                // Create/initialize image handler 
                ViewerImageHandler imageHandler = new ViewerImageHandler(Utilities.GetConfigurations());
            ...
            /// </summary>
            /// <param name="DocumentName"></param>
            public static void RenderDocumentWithoutAnnotations(String DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName"></param>
            public static void RenderWordDocumentWithTrackedChanges(String DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName"></param>
            public static void RenderDocumentWithJpegQualitySettings(String DocumentName)
            {
            ...
            /// </summary>
            /// <param name="DocumentName">File name</param> 
            public static void RenderPrintAreasInExcel(string DocumentName)
            {
            ...
            /// <summary>
            /// Renders Outlook messages as PDF
            /// </summary>
            /// <param name="DocumentName">Name of input document</param>
            public static void RenderOutlookDataFilesUsingFilters(String DocumentName)
            {
                try
                {
                    //ExStart:RenderOutlookDataFilesUsingFiltersAsPDF_19.1
                    // Setup GroupDocs.Viewer config
                    ViewerConfig config = Utilities.GetConfigurations();
                    ...
                    // For text filter, use OutlookOptions.TextFilter = "Susan";
                    ...
                    //Save file
                    Utilities.SaveFile(guid, fileContainer.Stream);
                    //ExEnd:RenderOutlookDataFilesUsingFiltersAsPDF_19.1
                }
                catch (System.Exception exp)
                {
                    Console.WriteLine(exp.Message);
        ...
        #region WorkingWithEmailAttachments
        /// <summary>
        ...
        public static void GetEmailAttachmentsFromOutlookDataFile(String DocumentName)
        {
            try
            {
                ...
                // Iterate over the attachments collection
                foreach (Attachment attachment in info.Attachments)
                {
                    // Print attachment name and file type
                    Console.WriteLine("Attach name: {0}, size: {1}", attachment.Name, attachment.FileType);

                    // Get attachment's original file and print Stream's length
                    using (FileContainer fileContainer = handler.GetFile(attachment))
                    {
                        Console.WriteLine("Attach stream lenght: {0}", fileContainer.Stream.Length);
                    }
                }
        ...
        /// <summary>
        /// Gets visibility status of CAD layers
        /// </summary>
        /// <param name="DocumentName">Name of input document</param>
        public static void GetVisibilityStatusOfCADLayers(String DocumentName)
        {
            try
            {
                //ExStart:GetVisibilityStatusOfCADLayers_19.1
                // Setup GroupDocs.Viewer config
                ViewerConfig config = Utilities.GetConfigurations();
                ...
                //ExEnd:GetVisibilityStatusOfCADLayers_19.1
            }
            catch (System.Exception exp)
            {
                Console.WriteLine(exp.Message);
        ...
        #region WorkingWithDocumentCache
        /// <summary>
        /// Removes cache files 
        /// </summary>
        ...
        /// </summary>
        /// <param name="DocumentName"></param>
        public static void GetOriginalDocument(String DocumentName)
        {
