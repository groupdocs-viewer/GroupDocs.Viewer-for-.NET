...
using GroupDocsViewerVisualStudioPlugin.GUI;
using GroupDocsViewerVisualStudioPlugin.Properties;

namespace GroupDocsViewerVisualStudioPlugin
{
    public class Connect : Extensibility.IDTExtensibility2, IDTCommandTarget
    {
        ...
        private const string GROUPDOCS_MENU_TOOLTIP = "Download and Run GroupDocs.Viewer for .NET API Examples";

        private const string VIEWER_COMMAND_NAME = "GroupDocsViewerVSPlugin";
        private const string VIEWER_COMMAND_CAPTION = "New GroupDocs.Viewer Example Project";
        private const string VIEWER_COMMAND_TOOLTIP = "Download and Run GroupDocs.Viewer for .NET API Examples";
