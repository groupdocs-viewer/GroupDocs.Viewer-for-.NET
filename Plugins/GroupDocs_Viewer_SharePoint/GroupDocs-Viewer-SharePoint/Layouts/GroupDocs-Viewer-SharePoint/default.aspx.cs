    ...
    public partial class @default : LayoutsPageBase
    {
        ...
        private static void ViewDocumentAsHtml(ViewDocumentParameters request, ViewDocumentResponse result, string fileName)
        {
            ...
            var htmlOptions = new HtmlOptions
            {
                ...
                HtmlResourcePrefix = string.Format("/_layouts/15/GroupDocs-Viewer-SharePoint/GetResourceForHtml.aspx?documentPath={0}", fileName) + "&pageNumber={page-number}&resourceName=",
            };
        ...
        public static object GetDocumentPageHtml(GetDocumentPageHtmlParameters parameters)
        {
            ...
            var htmlOptions = new HtmlOptions
            {
                ...
                HtmlResourcePrefix = string.Format(
                    "/_layouts/15/GroupDocs-Viewer-SharePoint/GetResourceForHtml.aspx?documentPath={0}", parameters.Path) +
