<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GroupDocs.Viewer.Live.Demos.UI.ViewerApp.Default" %>
...
<head runat="server">
	...
	<title>GroupDocs Viewer App</title>
	<link href="/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />

	<script src="/ViewerApp/qi/doc/js/custom.js?v1.8"></script>
	<script>
		fileName = '<%= fileName%>';
	...
	<script src="/ViewerApp/qi/doc/js/app.js?v1.14"></script>
			...
			<div class="container-fluid" style="padding-right: 5px!important;">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="#" style="padding: 5px 15px;">
						<img src="/images/GroupDocs-logo.png" alt="GroupDocs Document Viewer App" />
					</a>
				</div>
				<div class="collapse navbar-collapse" style="color: #fff;">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<button type="button" data-title="Print" ng-click="printPdf()" class="navbar-toggle titip-left" style="border: none!important;">
						...
						<li>
							...
							<ul class="dropdown-menu" tabindex="-1" role="menu">
								<li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="/GroupDocsapi/api/GroupDocsViewer/downloaddocument?file=<%= fileName%>&folderName=<%= folderName%>&isImage=false"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download Original</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="/GroupDocsapi/api/GroupDocsViewer/downloaddocument?file=<%= fileName%>&folderName=<%= folderName%>&isImage=true"><i class="glyphicon glyphicon-compressed"></i>&nbsp;Download As Images</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" ng-href="/GroupDocsapi/api/GroupDocsViewer/downloadpdfdocument?file=<%= fileName%>&folderName=<%= folderName%>"><i class="glyphicon glyphicon-download-alt"></i>&nbsp;Download As PDF</a></li>
							</ul>
						</li>
						<li>
					...
					<ul class="nav navbar-nav navbar-right" style="margin-right: 23vw;">
						<li>
